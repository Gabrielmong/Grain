...
export default function LumberList({ lumber, onEdit, onDelete, onRestore }: LumberListProps) {
  return (
                ...
                <Stack spacing={1.5}>
                  ...
                  >
                    ...
                    <Typography variant="body2" sx={{ fontWeight: 700, color: 'primary.main' }}>
                      {item.jankaRating.toLocaleString()} lbf
                    </Typography>
                  </Box>
                  <Box
                    sx={{
                  ...
                  >
                    ...
                    <Typography variant="body2" sx={{ fontWeight: 700, color: 'success.main' }}>
                      ₡{item.costPerBoardFoot.toFixed(2)}
                    </Typography>
                  </Box>
                </Stack>
